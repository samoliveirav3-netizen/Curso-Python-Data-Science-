...
def mostra_grafico():
    dados  =  pd.read_csv('DataSete/dados.csv')
...
texto.grid(row=1,column=2,pady= 20  )
...
btn.grid(row=2, column=2, pady=20)


btn2  =  tk.Button(janela, text= 'clique aqui', font=('arial', 16), command=mostra_grafico)
btn2.grid(row=3, column=2, pady=20)
